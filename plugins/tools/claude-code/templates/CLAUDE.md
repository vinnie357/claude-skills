...
- three-gate step order (see /core:git Three-Gate Merge Policy): Gate 1 local CI → commit → gitleaks → push → PR → Gate 2 watch remote CI → Gate 3 adversarial review by a separate strongest-reasoning-tier agent (ADR 0001 decision 4) → notify
